...
# Load Trained Model
# -------------------------------------------------
model = joblib.load("_MLProject2_.joblib")  # Make sure the file is in your app folder
